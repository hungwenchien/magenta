...
#define MX_PCI_MAX_BUSSES (256u)
#define MX_PCI_MAX_DEVICES_PER_BUS (32u)
#define MX_PCI_MAX_FUNCTIONS_PER_DEVICE (8u)
#define MX_PCI_MAX_FUNCTIONS_PER_BUS (MX_PCI_MAX_DEVICES_PER_BUS * MX_PCI_MAX_FUNCTIONS_PER_DEVICE)

#define MX_PCI_MAX_LEGACY_IRQ_PINS (4u)
#define MX_PCI_MAX_MSI_IRQS        (32u)
#define MX_PCI_MAX_MSIX_IRQS       (2048u)

#define MX_PCI_STANDARD_CONFIG_HDR_SIZE (64u)
#define MX_PCI_BASE_CONFIG_SIZE         (256u)
#define MX_PCI_EXTENDED_CONFIG_SIZE     (4096u)
#define MX_PCI_ECAM_BYTE_PER_BUS (MX_PCI_EXTENDED_CONFIG_SIZE * MX_PCI_MAX_FUNCTIONS_PER_BUS)

#define MX_PCI_BAR_REGS_PER_BRIDGE    (2u)
#define MX_PCI_BAR_REGS_PER_DEVICE    (6u)
#define MX_PCI_MAX_BAR_REGS           (6u)
...
typedef uint32_t mx_pci_irq_swizzle_lut_t[MX_PCI_MAX_DEVICES_PER_BUS]
                                         [MX_PCI_MAX_FUNCTIONS_PER_DEVICE]
                                         [MX_PCI_MAX_LEGACY_IRQ_PINS];
